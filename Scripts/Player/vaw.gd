...
@onready var level_titles: AnimatedSprite2D = $Camera/TransitionsLayer/LevelTitles
...
func credits_music():
	...
	if james_music:
		...
		if under.james.volume_db < -10:
			under.james.volume_db += 0.05
	else:
